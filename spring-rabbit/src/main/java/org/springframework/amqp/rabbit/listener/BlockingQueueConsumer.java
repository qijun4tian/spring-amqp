...
public class BlockingQueueConsumer {
    ...
    private final class shardInternalConsumer extends InternalConsumer {
        ...
        public void handleDelivery(String consumerTag, Envelope envelope, AMQP.BasicProperties properties, byte[] body)
            ...
            Integer shard = additiveHash(msg.get(BlockingQueueConsumer.this.keyProperty), BlockingQueueConsumer.this.maxConcurrentConsumers);
